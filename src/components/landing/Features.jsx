import PlanetImg from "../../assets/landing/planet.png";
import PlanetOverlayImg from "../../assets/landing/planet-overlay.svg";
import PlanetTagImg01 from "../../assets/landing/tag-01.png";
import PlanetTagImg02 from "../../assets/landing/tag-02.png";
import PlanetTagImg03 from "../../assets/landing/tag-03.png";
import PlanetTagImg04 from "../../assets/landing/tag-04.png";
        ...
        <div className="py-12 md:py-20">
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              ...
              <br /> a tu propio ritmo y sin límites.{" "}
            </h2>
          </div>
