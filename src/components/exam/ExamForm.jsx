                ...
                <div className='w-1/6'>
                    <div className="animate-bounce-in-down bg-white border border-blue-200 rounded-lg px-6 py-3 items-center gap-4 shadow-md">
                        <div className="grid items-center">
                            <h3 className="text-xl font-bold border-b border-gray-200 pb-3">{examTypes[examTypeIndex].label}</h3>
                            <span
                    ...
                    <div className='mt-4 grid'>
                        ...
                        <div className="flex items-center gap-2 mt-4">
                            <input
                                ...
                                onChange={(e) => setExamData({ ...examData, isFreeCode: e.target.checked })}
                                className="form-checkbox text-[#4558C8]"
                            />
                            <label htmlFor="freeCodeAccess" className="text-sm text-gray-600">
