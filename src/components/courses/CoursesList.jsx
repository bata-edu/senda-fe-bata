    ...
    <div className="flex flex-col items-center min-h-screen bg-grayBg">
        ...
        >
            <div className="flex gap-2">
                <img src={schoolInfo.logo} alt="Logo Instituto" className="h-6 w-6 rounded-full" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 w-4/5 max-w-5xl px-6">
          {courses.map((course) => (
            ...
            >
              <span className="text-4xl font-semibold block mb-10">{course.name}</span>
              <div className="flex justify-between">
                <span className="text-lg font-medium text-[#FEF3EE]">Codigo: {course.code}</span>
      ...
      >
        <div>
          <span className="text-4xl font-bold block mb-10">Crear nueva aula</span>
          <div className="flex justify-between">
            <span className="text-lg font-medium text-[#DD2E19]">Añade una nueva aula</span>
